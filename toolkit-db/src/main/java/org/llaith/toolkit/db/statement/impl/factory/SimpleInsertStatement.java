 ...
 *
 */
public class SimpleInsertStatement implements StatementFactory {

    private final String sql;
    private final String[] ids;

    public SimpleInsertStatement(final String sql) {
        this(sql,null);
    }


    public SimpleInsertStatement(final String sql, final String[] ids) {
    ...
    public PreparedStatement createStatement(DbConnection connection) throws SQLException {
        return (this.ids != null) ?
                connection.prepareStatement(sql,this.ids) :
