 ...
 *
 */
public class DbUtilsScalarHandler<T> implements ResultsHandler<T> {

    private final ScalarHandler<T> delegate;

    public DbUtilsScalarHandler(final String colname) {
        this.delegate = new ScalarHandler<>(colname);
    }
