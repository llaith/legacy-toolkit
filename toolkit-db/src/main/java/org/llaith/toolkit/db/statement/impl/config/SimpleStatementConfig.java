 ...
 *
 */
public class SimpleStatementConfig implements StatementConfigurer {

    private final Object[] params;

    private final PsParamProcessor helper = new PsParamProcessor();

    public SimpleStatementConfig(final Object... params) {
        this.params = params;
    }

    @Override
    public void configureStatement(final PreparedStatement preparedStatement) throws SQLException {
        this.helper.fillStatement(preparedStatement,this.params);
    }
